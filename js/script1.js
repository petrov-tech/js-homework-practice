...
// ## Example 6 - Методы строк и чейнинг (Надо разобратся)
...
// скрипта для следующих значений переменной `incomingValue`: null, undefined, 0,
// false. Используй оператор `??` (nullish coalescing operator).

// ```js
// const incomingValue = 5;
// const defaultValue = 10;
// const value = incomingValue > defaultValue ? incomingValue : defaultValue;
